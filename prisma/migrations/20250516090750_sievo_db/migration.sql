...
-- CreateEnum
CREATE TYPE "ClientType" AS ENUM ('INDIVIDUAL', 'CORPORATE', 'GOVERNMENT', 'EDUCATIONAL_INSTITUTION', 'COMMUNITIES_AND_ORGANIZATION', 'COMMERCIAL_BRAND_AND_AGENCY');

-- CreateEnum
CREATE TYPE "VendorType" AS ENUM ('DOCUMENTATION', 'SOUND_SYSTEM_AND_LIGHTING', 'TALENT_AND_ENTERTAINMENT', 'PRODUCTION_AND_DECORATION', 'TOOLS_AND_LOGISTIC', 'FOOD_AND_BEVERAGES', 'DIGITAL_AND_TECHNICAL', 'ACCOMODATION_AND_TRANSPORTATION', 'MEDICAL_AND_SECURITY', 'OTHERS');
...
CREATE TABLE "Vendor" (
    ...
    "type" "VendorType" NOT NULL DEFAULT 'OTHERS',
    "is_deleted" BOOLEAN NOT NULL DEFAULT false,
