...
import { BudgetItemStatusEnum, BudgetStatusEnum } from "../enums";

export const BudgetWithCategoryBudgetActual = z.object({
    budget_id: z
...
export type BudgetWithCategoryBudgetActual = z.infer<typeof BudgetWithCategoryBudgetActual>;
